...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <div class="container">
        <form action= "insertaruni.php" method="POST">
        <div class="mb-3">
            <label class="form-label">nombre y apellido</label>
            <input type="text" class="form-control" name="nombreU">
        </div>
        <div class="mb-3">
            ...
            <?php
               include 'Conexion.php';
                ...
                while ($resultado = $sql->fetch_assoc()) {
                    echo "<option value='".$resultado['Idprograma']."'>".$resultado
                    ['nombreprograma']."</option>";
                }
            ?>
        </select>
        ...
        <div class="text-center">
            ...
            <a href="uni.php" class="btn btn-dark">Regresar</a>
        </div>
